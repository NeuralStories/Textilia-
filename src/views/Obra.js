                  ...
                  <div class="pi obra-safe">
                    ...
                    <div class="tw-wrap hd-t" style="overflow-x: auto;">
                      <table class="dtbl" style="min-width: 1200px;">
                        <thead>
                          <tr>
                            <th class="r">HABITACION</th><th class="r">ANCHO HUECO</th><th class="r">ALTURA</th><th class="r">P. CONF.</th><th class="r">P. TELA</th><th class="r">P. INST.</th><th class="r">FRUNCIDO (cm)</th><th class="r">BAJO/CRESTA</th><th class="r">MED. HOJA</th><th class="r">Nº HOJAS</th><th class="r">MTS TELA</th><th class="r">COSTE TELA</th><th class="r">COSTE CONF.</th><th class="r">P. HUECO</th><th class="r">MARGEN</th><th class="r">BENEFICIO</th><th></th>
                          </tr>
                        </thead>
